 ...
 */
final class Version20230215060138 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE apartment (id INT AUTO_INCREMENT NOT NULL, building_id INT DEFAULT NULL, person_id INT DEFAULT NULL, title VARCHAR(255) DEFAULT NULL, size INT DEFAULT NULL, cold_water_status DOUBLE PRECISION DEFAULT NULL, hot_water_status DOUBLE PRECISION DEFAULT NULL, gas_meter_status DOUBLE PRECISION DEFAULT NULL, square_status DOUBLE PRECISION DEFAULT NULL, INDEX IDX_4D7E68544D2A7E12 (building_id), UNIQUE INDEX UNIQ_4D7E6854217BBB47 (person_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
